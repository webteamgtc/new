...
const FrequentlyAskedQuestions = ({ data }) => {
    ...
    return (
      ...
      <h2 className='HeadingH2 2xl:text-4xl font-[600] bg-gradient-to-r from-primary to-primary inline-block text-transparent bg-clip-text text-center mb-10'>Frequently Asked Questions
      </h2>
