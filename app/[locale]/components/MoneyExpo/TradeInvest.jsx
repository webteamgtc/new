    ...
    <section className="bg-[#050331] py-12 md:py-16 2xl:py-20">
      <div className="container">
        ...
        <div className="text-center mt-10">
          <p className="text-gray-200 max-w-2xl mx-auto mb-10">Join us on 14-16 January 2025, at World Trade Centre, Dubai, UAE. Visit us at Booth 59! and discover how GTCFX can help you achieve financial success. </p>
          <button
            onClick={(e) => {
              e.preventDefault();
