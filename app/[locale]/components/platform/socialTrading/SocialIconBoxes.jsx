...
const ProductItem = ({ icon, title, link, isLast }) => (
  <Link
    href={link}
    className={`relative md:col-span-1 flex flex-col items-center text-primary p-4 md:p-6 bg-secondary hover:z-40 hover:bg-primary hover:text-white text-gtcPrimary transform md:scale-300 transition-transform duration-500 md:ease-in-out md:hover:scale-110 hover:bg-opacity-100`}
  >
    {isLast ? null : (
...
export default SocialIconBoxes;
