...
const AppIconCtrader = ({windowLink, appleLink, globalLink, apkLink, playLink}) => {
    const linkItems = [
        {
          link: windowLink,
  ...
  return (
    ...
    <div className="flex justify-start items-center gap-3 pt-6">
      <div className="p-3 bg-primary text-white w-12 h-12 rounded-full text-center  hover:bg-secondary cursor-pointer">
      ...
      <ul className="relative py-1 flex justify-start items-start gap-2">
        ...
        <li key={index} className="p-3 bg-primary text-white w-12 h-12 rounded-full text-center hover:bg-secondary">
