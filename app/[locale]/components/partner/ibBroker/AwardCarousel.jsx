  ...
  return (
    <section className="md:py-12 3xl:py-16 py-8 ib-award">
      <div className="container text-center">
        <h2 className="HeadingH2 2xl:text-4xl w-72 md:w-full font-[500] bg-gradient-to-r from-primary to-secondary inline-block text-transparent bg-clip-text text-center">{t("title")}</h2>
        <Swiper
