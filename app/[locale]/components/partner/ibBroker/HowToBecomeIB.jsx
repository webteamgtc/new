...
const HowToBecomeIB = ({ title, subtitle, steps, gridCols = 'lg:grid-cols-4', bgColor = 'bg-gray-200' }) => {
  return (
    <section className={`${bgColor}`}>
      ...
      <h2 className='HeadingH2 2xl:text-4xl w-72 md:w-full font-[500] bg-gradient-to-r from-primary to-secondary inline-block text-transparent bg-clip-text text-center capitalize'>{title}</h2>
