...
const PaginatedImageGallery = ({ images }) => {
  ...
  return (
    <div className="container mx-auto pb-12 md:pb-14 xl:pb-16 2xl:pb-24">
      <div class="text-center mb-10">
        <h2 className="HeadingH2 bg-gradient-to-r from-primary to-secondary inline-block text-transparent bg-clip-text text-center">VIP IBs event organized by GTCFX in Dubai</h2>
