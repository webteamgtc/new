    ...
    <>
      ...
      <div className="inner-content">
        <div className="container">
            <PdfDocument 
            url='https://gtcfx-bucket.s3.ap-southeast-1.amazonaws.com/pdf-files/Mauritius.pdf' 
            dir='https://gtcfx-bucket.s3.ap-southeast-1.amazonaws.com/pdf-files/Mauritius.pdf'/>
        </div>
      </div>
    </>
  );
